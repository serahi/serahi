...
function cke_initialize($data = array()) {
	...
	if(!defined('CI_CKEDITOR_HELPER_LOADED')) {
		...
		$return =  '<script type="text/javascript" src="'.base_url(). 'assets/ckeditor/'  . 'ckeditor.js"></script>';
		$return .=	"<script type=\"text/javascript\">CKEDITOR_BASEPATH = '" . base_url() .'assets/ckeditor'  . "/';</script>";
	} 
