...
if (isset($products)) {
	...
	foreach ($products as $item) {
		...
		if (!$item['is_bought']) {
			...
			echo ' <form method="post" action="'. base_url() .'home/buy" class="forms cancel_buying" > <input type="submit" value="لغو خرید">  <input type="hidden" value="' . $item['id'] . '" name="product_id"></form> ';
		}
		echo '</div>';
